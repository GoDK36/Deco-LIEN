...
form_class = uic.loadUiType ("./UI/LIEN.ui")[0]
...
<html>
  <head>
    ...
    <title>DecoLIEN</title>
  </head>
    
  <body>
    <h1 style="font-family: 'Outfit', sans-serif; font-weight: 700"><img src="../UI/DICORA-logo.png" alt="DICORA Logo" style="width:2.0rem;height:2.0rem; margin-right:0.5rem;">DecoLIEN</h1>
    <div class='groove'>
...
"""
    ...
    """
        ...
        # 결과 txt 파일로 자동 저장        
        result_txt_path = os.getcwd() + r'/LIEN_result_text.txt'
...
class LIENUI (QMainWindow, form_class):
    def __init__(self):
        ...
        # label = QLabel("label_6", self)
        QFontDatabase.addApplicationFont("./CooperFiveOpti-Black.otf")
        self.label_6.setStyleSheet("QLabel{font-size: 55px;font-family: 'CooperFiveOpti Black';color: #0083E6}")
